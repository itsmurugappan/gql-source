...
import (
	...
	versionedscheme "github.com/itsmurugappan/gql-source/pkg/client/clientset/versioned/scheme"
	client "github.com/itsmurugappan/gql-source/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "gqlsource-controller"
	defaultFinalizerName       = "gqlsources.sources.muru.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	gqlsourceInformer := gqlsource.Get(ctx)

	lister := gqlsourceInformer.Lister()
